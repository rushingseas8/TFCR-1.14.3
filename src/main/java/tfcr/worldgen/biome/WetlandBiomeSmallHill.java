 ...
 */
public class WetlandBiomeSmallHill extends BaseTFCRBiome {
    public WetlandBiomeSmallHill() {
        super(-30, 15, 40, 65, TerrainType.SMALL_HILLS,
                new BiomeBuilder()
        ...
        this.setRegistryName(TFCR.MODID, "wetland_smallhill");
    }
}
