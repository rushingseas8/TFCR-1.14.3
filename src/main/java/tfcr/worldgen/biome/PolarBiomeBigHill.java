 ...
 */
public class PolarBiomeBigHill extends BaseTFCRBiome {
    public PolarBiomeBigHill() {
        super(-100, -60, 0, 100, TerrainType.BIG_HILLS,
                (new BiomeBuilder())
        ...
        this.setRegistryName(TFCR.MODID, "polar_bighill");
    }
}
