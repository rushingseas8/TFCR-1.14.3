...
//
//                        float averageDepth = (terrainType.depth + terrainType1.depth) / 2f;
//                        float averageScale = (terrainType.scale + terrainType1.scale) / 2f;
//
//                        float f5 = this.settings.func_202203_v() + terrainType1.depth * this.settings.func_202202_w();
////                        float f5 = this.settings.func_202203_v() + averageDepth * this.settings.func_202202_w();
//                        float f6 = this.settings.func_202204_x() + terrainType1.scale * this.settings.func_202205_y();
////                        float f6 = this.settings.func_202204_x() + averageScale * this.settings.func_202205_y();
//
...
////                        f7 = 0;
//
//                        // Weighted average of depth (f2) and scale (f3), with cumulative weight (f4)
//                        f2 += f6 * f7;
//                        f3 += f5 * f7;
//                        f4 += f7;
//                    }
